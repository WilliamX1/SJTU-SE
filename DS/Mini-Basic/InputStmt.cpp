...
InputStmt::InputStmt(QString stmt): Statement(stmt) {
    _contents = stmt.section(' ', 2, -1).simplified();
}
/*override*/
void InputStmt::printToScreen(QTextBrowser* ui_textbrowser) {
    /*打印行号*/
...
/*override*/
void InputStmt::getSyntaxTree(){

}; //获得语句与语法树
/*override*/
bool InputStmt::checkUserInputValid(QString& errorName) {
